...
from openjob.collection.base import CollectionBlockedError, CollectionError, CollectorHooks
from openjob.collection.models import PlatformCollectionRequest
from openjob.collection.platforms.zhilian import (
    JD_CLASSES,
    JS_EXTRACT_DETAIL,
    JS_EXTRACT_LIST,
    ZhilianBrowser,
...
class ZhilianFixtureTests(TestCase):
    def test_city_snapshot_is_local_and_not_shared_with_boss_codes(self):
        ...
        self.assertEqual(snapshot["schema"], "openjob.zhilian_cities.v1")
