...
from openjob.web.preflight import check_ai_connection, check_browser_connection, collect_preflight_checks
...
class AiPreflightTests(unittest.TestCase):
	...
	@patch("openjob.web.preflight.httpx.get")
...
class BrowserPreflightTests(unittest.TestCase):
	@patch("openjob.web.preflight.run_browser_diagnostics")
	...
	@patch("openjob.web.preflight.check_ai_connection")
	@patch("openjob.web.preflight.check_browser_connection")
