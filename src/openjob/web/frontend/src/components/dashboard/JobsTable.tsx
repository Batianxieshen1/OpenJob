                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          {job.company_size && (
                            <span className="rounded-full bg-surface-hover px-2 py-0.5 text-[10px] font-bold text-muted">{job.company_size}</span>
                          )}
                        </div>
                      </td>
                        ...
                        <td className="px-3 py-3" onClick={event => event.stopPropagation()}>
                          <div className="flex flex-wrap items-center justify-center gap-1.5">
                            {isExternalPlatform && externalUrl && (
                              <a href={externalUrl} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 rounded-lg border border-card-border px-2 py-1.5 text-[11px] font-bold text-primary hover:bg-accent-soft">
                            ...
                            {job.status === 'filtered' && onApprove && (
                              <button
                                ...
                                className="inline-flex items-center gap-1 rounded-lg border border-primary/40 px-2 py-1.5 text-[11px] font-bold text-primary hover:bg-accent-soft"
                              >放行到确认队列</button>
                            )}
                            {onSoftDelete && (
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 border-t border-card-border px-4 py-3 text-xs">
            ...
            <label className="flex items-center gap-1 text-muted">
              ...
              <input
                ...
                onBlur={jumpToPage}
                aria-label="跳转页码"
                className="w-14 rounded-md border border-card-border bg-surface-hover px-2 py-1 text-center text-foreground outline-none focus:border-primary"
              />
              页 / {totalPages} 页
            </label>
            <button
