...
export default function ConfigPage() {
  ...
  const handleAiTest = async () => {
    ...
    try {
      ...
      setAiTest({ testing: false, ok: false, message: '无法连接本地检测接口，请确认 OpenJob 后端正在运行。' })
    }
  }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              {resumeInfo ? (
                ...
                <label className="flex cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-card-border p-6 transition-colors hover:border-primary/50 hover:bg-surface-hover">
            ...
            <Field label="招呼语偏好">
              <textarea
                ...
                rows={3}
                maxLength={500}
                className="w-full resize-y rounded-md border border-card-border bg-surface-hover px-3 py-2 text-sm text-foreground outline-none placeholder:text-muted focus:border-primary"
              />
        ...
        <SectionCard title="搜索设置" sectionKey="search" expanded={expandedSections} toggle={toggleSection}>
          <div className="space-y-4">
            ...
            <div className="grid gap-3 md:grid-cols-2">
              ...
              <div className="flex items-center justify-between rounded-xl border border-card-border bg-surface-hover px-3 py-2 text-xs font-bold text-muted">
                采集后自动评分
          ...
          <div className="space-y-4">
            <Field label="提供商">
              ...
              <p className="mt-1 text-xs text-muted">
                OpenJob 会自动配置协议和服务地址；也可安全复用环境变量 {
            ...
            <div className="flex items-center justify-between rounded-lg border border-card-border bg-surface-hover p-3">
              <div>
        ...
        <SectionCard title="反监测设置" sectionKey="collection" expanded={expandedSections} toggle={toggleSection}>
          <div className="space-y-4">
            ...
            <div className="grid items-end gap-4 md:grid-cols-2">
              <div className="flex h-9 items-center justify-between rounded-md border border-card-border bg-surface-hover px-3">
    ...
    <Field label={label}>
      <div className="flex h-9 items-center overflow-hidden rounded-md border border-card-border bg-card focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/30">
        ...
        <input
          ...
          disabled={disabled}
        />
        <span className="flex h-full shrink-0 items-center border-x border-card-border bg-surface-hover px-3 text-xs font-bold text-muted">至</span>
