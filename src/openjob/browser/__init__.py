"""Browser facade backed by OpenJob's built-in Browser Runtime."""
...
from openjob.browser.client import RuntimeClient
from openjob.browser.runtime import ensure_runtime, get_runtime_url, set_browser_config
